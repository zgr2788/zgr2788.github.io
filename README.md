...
* Project listings use the tracked images in `images/` directly. The `_make_thumbnails.sh` script is kept around for optional thumbnail generation, but the template no longer depends on a generated `tn/` directory.
